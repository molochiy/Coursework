...
namespace Coursework.Web
{
  public class BundleConfig
  {
    public static void RegisterBundles(BundleCollection bundles)
    {
      ...
      bundles.Add(new StyleBundle("~/bundles/css").Include("~/Content/css/custom/common.css", "~/Content/css/custom/user.css", "~/Content/css/custom/menu.css", "~/Content/css/custom/flexslider.css"));
